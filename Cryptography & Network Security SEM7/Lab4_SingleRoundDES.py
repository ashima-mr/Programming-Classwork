...
S_BOXES = [
    ...
    [[4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1],
     ...
     [3, 6, 12, 5, 15, 10, 9, 0, 8, 13, 1, 14, 7, 11, 4, 2]],
...
# The zip function combines block1 and block2 into pairs of corresponding elements.
...
def des_round(plain_block, round_key):
...
cipher_block = des_round(plain_block, round_key)
